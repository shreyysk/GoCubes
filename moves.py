...
def expand_wide_moves(sequence: str) -> str:
    ...
    """
    expansions = {
        'u': ["D", "y"],     # Wide U affects entire cube except D
        "u'": ["D'", "y'"],
        'u2': ["D2", "y2"],
        'd': ["U", "y'"],    # Wide D affects entire cube except U
        "d'": ["U'", "y"],
        'd2': ["U2", "y2"],
        'r': ["L", "x"],     # Wide R affects entire cube except L
        "r'": ["L'", "x'"],
        'r2': ["L2", "x2"],
        'l': ["R", "x'"],    # Wide L affects entire cube except R
        "l'": ["R'", "x"],
        'l2': ["R2", "x2"],
        'f': ["B", "z"],     # Wide F affects entire cube except B
        "f'": ["B'", "z'"],
        'f2': ["B2", "z2"],
        'b': ["F", "z'"],    # Wide B affects entire cube except F
        "b'": ["F'", "z"],
        'b2': ["F2", "z2"],
    }
